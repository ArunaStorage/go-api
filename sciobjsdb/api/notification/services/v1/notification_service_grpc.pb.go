...
func (c *updateNotificationServiceClient) CreateEventStreamingGroup(ctx context.Context, in *CreateEventStreamingGroupRequest, opts ...grpc.CallOption) (*CreateEventStreamingGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sciobjsdb.api.notification.services.v1.UpdateNotificationService/CreateEventStreamingGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *updateNotificationServiceClient) NotificationStreamGroup(ctx context.Context, opts ...grpc.CallOption) (UpdateNotificationService_NotificationStreamGroupClient, error) {
	stream, err := c.cc.NewStream(ctx, &UpdateNotificationService_ServiceDesc.Streams[0], "/sciobjsdb.api.notification.services.v1.UpdateNotificationService/NotificationStreamGroup", opts...)
	if err != nil {
		return nil, err
	}
...
func _UpdateNotificationService_CreateEventStreamingGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sciobjsdb.api.notification.services.v1.UpdateNotificationService/CreateEventStreamingGroup",
	}
