...
func RegisterUpdateNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UpdateNotificationServiceServer) error {
	...
	mux.Handle("POST", pattern_UpdateNotificationService_CreateEventStreamingGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.notification.services.v1.UpdateNotificationService/CreateEventStreamingGroup", runtime.WithHTTPPathPattern("/api/v1/eventstream/createstreaminggroup"))
		if err != nil {
...
func RegisterUpdateNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UpdateNotificationServiceClient) error {
	...
	mux.Handle("POST", pattern_UpdateNotificationService_CreateEventStreamingGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.notification.services.v1.UpdateNotificationService/CreateEventStreamingGroup", runtime.WithHTTPPathPattern("/api/v1/eventstream/createstreaminggroup"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UpdateNotificationService_NotificationStreamGroup_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.notification.services.v1.UpdateNotificationService/NotificationStreamGroup", runtime.WithHTTPPathPattern("/api/v1/eventstreamgroup/notifications"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
