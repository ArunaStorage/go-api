...
var (
	filter_ObjectLoadService_CreateDownloadLink_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_ObjectLoadService_CreateDownloadLink_0(ctx context.Context, marshaler runtime.Marshaler, client ObjectLoadServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ObjectLoadService_CreateDownloadLink_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func request_ObjectLoadService_CreateDownloadLinkBatch_0(ctx context.Context, marshaler runtime.Marshaler, client ObjectLoadServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateDownloadLinkBatchRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.CreateDownloadLinkBatch(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ObjectLoadService_CreateDownloadLinkBatch_0(ctx context.Context, marshaler runtime.Marshaler, server ObjectLoadServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateDownloadLinkBatchRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateDownloadLinkBatch(ctx, &protoReq)
	return msg, metadata, err

}

func request_ObjectLoadService_CreateDownloadLinkStream_0(ctx context.Context, marshaler runtime.Marshaler, client ObjectLoadServiceClient, req *http.Request, pathParams map[string]string) (ObjectLoadService_CreateDownloadLinkStreamClient, runtime.ServerMetadata, error) {
	var protoReq CreateDownloadLinkStreamRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.CreateDownloadLinkStream(ctx, &protoReq)
	if err != nil {
...
func RegisterObjectLoadServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ObjectLoadServiceServer) error {
	...
	mux.Handle("GET", pattern_ObjectLoadService_CreateUploadLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateUploadLink", runtime.WithHTTPPathPattern("/api/v1/objectload/upload/{id}"))
		if err != nil {
	...
	mux.Handle("GET", pattern_ObjectLoadService_CreateDownloadLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateDownloadLink", runtime.WithHTTPPathPattern("/api/v1/objectload/download/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ObjectLoadService_CreateDownloadLinkBatch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateDownloadLinkBatch", runtime.WithHTTPPathPattern("/api/v1/objectload/download_batch"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ObjectLoadService_CreateDownloadLinkBatch_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ObjectLoadService_CreateDownloadLinkBatch_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_ObjectLoadService_CreateDownloadLinkStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle("POST", pattern_ObjectLoadService_StartMultipartUpload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/StartMultipartUpload", runtime.WithHTTPPathPattern("/api/v1/objectload/init_multipart/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ObjectLoadService_GetMultipartUploadLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/GetMultipartUploadLink", runtime.WithHTTPPathPattern("/api/v1/objectload/upload_multipart_part/{object_id}/{upload_part}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ObjectLoadService_CompleteMultipartUpload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CompleteMultipartUpload", runtime.WithHTTPPathPattern("/api/v1/objectload/complete_multipart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterObjectLoadServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ObjectLoadServiceClient) error {
	...
	mux.Handle("GET", pattern_ObjectLoadService_CreateUploadLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateUploadLink", runtime.WithHTTPPathPattern("/api/v1/objectload/upload/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ObjectLoadService_CreateDownloadLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateDownloadLink", runtime.WithHTTPPathPattern("/api/v1/objectload/download/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ObjectLoadService_CreateDownloadLinkBatch_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateDownloadLinkBatch", runtime.WithHTTPPathPattern("/api/v1/objectload/download_batch"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ObjectLoadService_CreateDownloadLinkBatch_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ObjectLoadService_CreateDownloadLinkStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CreateDownloadLinkStream", runtime.WithHTTPPathPattern("/api/v1/objectload/download_batch_stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ObjectLoadService_CreateDownloadLinkStream_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ObjectLoadService_CreateDownloadLinkStream_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ObjectLoadService_StartMultipartUpload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/StartMultipartUpload", runtime.WithHTTPPathPattern("/api/v1/objectload/init_multipart/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ObjectLoadService_GetMultipartUploadLink_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/GetMultipartUploadLink", runtime.WithHTTPPathPattern("/api/v1/objectload/upload_multipart_part/{object_id}/{upload_part}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ObjectLoadService_CompleteMultipartUpload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.ObjectLoadService/CompleteMultipartUpload", runtime.WithHTTPPathPattern("/api/v1/objectload/complete_multipart"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_ObjectLoadService_CreateDownloadLinkBatch_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "objectload", "download_batch"}, ""))

	pattern_ObjectLoadService_CreateDownloadLinkStream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "objectload", "download_batch_stream"}, ""))
...
var (
	...
	forward_ObjectLoadService_CreateDownloadLinkBatch_0 = runtime.ForwardResponseMessage

	forward_ObjectLoadService_CreateDownloadLinkStream_0 = runtime.ForwardResponseStream
