...
func request_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0(ctx context.Context, marshaler runtime.Marshaler, client DatasetObjectsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateObjectGroupRevisionFromRevisionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.CreateObjectGroupRevisionFromRevision(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0(ctx context.Context, marshaler runtime.Marshaler, server DatasetObjectsServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateObjectGroupRevisionFromRevisionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateObjectGroupRevisionFromRevision(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDatasetObjectsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DatasetObjectsServiceServer) error {
	...
	mux.Handle("POST", pattern_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.DatasetObjectsService/CreateObjectGroupRevisionFromRevision", runtime.WithHTTPPathPattern("/api/v1/objectgrouprevision/createfromrevision"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDatasetObjectsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DatasetObjectsServiceClient) error {
	...
	mux.Handle("POST", pattern_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/sciobjsdb.api.storage.services.v1.DatasetObjectsService/CreateObjectGroupRevisionFromRevision", runtime.WithHTTPPathPattern("/api/v1/objectgrouprevision/createfromrevision"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "objectgrouprevision", "createfromrevision"}, ""))
...
var (
	...
	forward_DatasetObjectsService_CreateObjectGroupRevisionFromRevision_0 = runtime.ForwardResponseMessage
