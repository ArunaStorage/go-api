...
var file_api_services_ProjectServiceModels_proto_rawDesc = []byte{
	...
	0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x42, 0x77,
	0x0a, 0x2d, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x53, 0x63, 0x69,
	0x65, 0x6e, 0x63, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x44, 0x42, 0x2e, 0x6a, 0x61,
	0x76, 0x61, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42,
	0x17, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x50, 0x49, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x50, 0x01, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68,
...
var file_api_services_ProjectServiceModels_proto_goTypes = []interface{}{
	...
	(*models.Metadata)(nil),         // 4: models.Metadata
	(*models.Label)(nil),            // 5: models.Label
	(models.Right)(0),               // 6: models.Right
	(*models.Project)(nil),          // 7: models.Project
	(*models.Dataset)(nil),          // 8: models.Dataset
}
var file_api_services_ProjectServiceModels_proto_depIdxs = []int32{
	4, // 0: services.CreateProjectRequest.metadata:type_name -> models.Metadata
	5, // 1: services.CreateProjectRequest.labels:type_name -> models.Label
	6, // 2: services.AddUserToProjectRequest.scope:type_name -> models.Right
	7, // 3: services.ProjectList.projects:type_name -> models.Project
	8, // 4: services.DatasetList.dataset:type_name -> models.Dataset
	5, // 5: services.DatasetList.labels:type_name -> models.Label
