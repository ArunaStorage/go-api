...
var file_api_services_v1_dataset_object_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0xb2, 0x07, 0x0a, 0x15, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x4f, 0x62,
	...
	0xe4, 0x93, 0x02, 0x24, 0x22, 0x1f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x62, 0x61, 0x74, 0x63, 0x68, 0x2f, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0xb3, 0x01, 0x0a, 0x17, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x12, 0x2f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	...
	0x6a, 0x65, 0x63, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x31, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2b, 0x22,
	0x26, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x67,
	0x72, 0x6f, 0x75, 0x70, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x28, 0x01, 0x30, 0x01, 0x12, 0x85,
	0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x12, 0x26, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	...
	0x67, 0x65, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x8f, 0x01, 0x0a, 0x12, 0x46, 0x69, 0x6e, 0x69, 0x73,
	...
	0x75, 0x70, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0x84, 0x01, 0x0a, 0x34, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_api_services_v1_dataset_object_service_proto_goTypes = []interface{}{
	...
	(*CreateObjectGroupStreamRequest)(nil),  // 2: api.services.v1.CreateObjectGroupStreamRequest
	(*GetObjectGroupRequest)(nil),           // 3: api.services.v1.GetObjectGroupRequest
	(*FinishObjectUploadRequest)(nil),       // 4: api.services.v1.FinishObjectUploadRequest
	(*DeleteObjectGroupRequest)(nil),        // 5: api.services.v1.DeleteObjectGroupRequest
	(*CreateObjectGroupResponse)(nil),       // 6: api.services.v1.CreateObjectGroupResponse
	(*CreateObjectGroupBatchResponse)(nil),  // 7: api.services.v1.CreateObjectGroupBatchResponse
	(*CreateObjectGroupStreamResponse)(nil), // 8: api.services.v1.CreateObjectGroupStreamResponse
	...
	(*DeleteObjectGroupResponse)(nil),       // 11: api.services.v1.DeleteObjectGroupResponse
}
var file_api_services_v1_dataset_object_service_proto_depIdxs = []int32{
	...
	2,  // 2: api.services.v1.DatasetObjectsService.CreateObjectGroupStream:input_type -> api.services.v1.CreateObjectGroupStreamRequest
	3,  // 3: api.services.v1.DatasetObjectsService.GetObjectGroup:input_type -> api.services.v1.GetObjectGroupRequest
	4,  // 4: api.services.v1.DatasetObjectsService.FinishObjectUpload:input_type -> api.services.v1.FinishObjectUploadRequest
	5,  // 5: api.services.v1.DatasetObjectsService.DeleteObjectGroup:input_type -> api.services.v1.DeleteObjectGroupRequest
	6,  // 6: api.services.v1.DatasetObjectsService.CreateObjectGroup:output_type -> api.services.v1.CreateObjectGroupResponse
	7,  // 7: api.services.v1.DatasetObjectsService.CreateObjectGroupBatch:output_type -> api.services.v1.CreateObjectGroupBatchResponse
	8,  // 8: api.services.v1.DatasetObjectsService.CreateObjectGroupStream:output_type -> api.services.v1.CreateObjectGroupStreamResponse
	9,  // 9: api.services.v1.DatasetObjectsService.GetObjectGroup:output_type -> api.services.v1.GetObjectGroupResponse
	10, // 10: api.services.v1.DatasetObjectsService.FinishObjectUpload:output_type -> api.services.v1.FinishObjectUploadResponse
	11, // 11: api.services.v1.DatasetObjectsService.DeleteObjectGroup:output_type -> api.services.v1.DeleteObjectGroupResponse
