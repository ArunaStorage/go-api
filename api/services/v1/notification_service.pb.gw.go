...
func request_UpdateNotificationService_NotificationAck_0(ctx context.Context, marshaler runtime.Marshaler, client UpdateNotificationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq NotificationAckRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.NotificationAck(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_UpdateNotificationService_NotificationAck_0(ctx context.Context, marshaler runtime.Marshaler, server UpdateNotificationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq NotificationAckRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.NotificationAck(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterUpdateNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UpdateNotificationServiceServer) error {
	...
	mux.Handle("POST", pattern_UpdateNotificationService_NotificationAck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/api.services.v1.UpdateNotificationService/NotificationAck", runtime.WithHTTPPathPattern("/api/v1/eventstream/ack"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_UpdateNotificationService_NotificationAck_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_UpdateNotificationService_NotificationAck_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterUpdateNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UpdateNotificationServiceClient) error {
	...
	mux.Handle("POST", pattern_UpdateNotificationService_NotificationAck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/api.services.v1.UpdateNotificationService/NotificationAck", runtime.WithHTTPPathPattern("/api/v1/eventstream/ack"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_UpdateNotificationService_NotificationAck_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_UpdateNotificationService_NotificationAck_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "eventstream", "ack"}, ""))
)

var (
	forward_UpdateNotificationService_NotificationStream_0 = runtime.ForwardResponseStream

	forward_UpdateNotificationService_NotificationAck_0 = runtime.ForwardResponseMessage
)
