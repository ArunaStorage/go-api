...
type ObjectGroup struct {
	...
	HeadId          uint64      `protobuf:"varint,7,opt,name=head_id,json=headId,proto3" json:"head_id,omitempty"`
...
func (x *ObjectGroup) GetDatasetId() uint64 {
	if x != nil {
		return x.DatasetId
	}
	return 0
...
func (x *ObjectGroup) GetHeadId() uint64 {
	if x != nil {
		return x.HeadId
	}
	return 0
...
type ObjectGroupRevision struct {
	...
	ObjectGroupId uint64                 `protobuf:"varint,10,opt,name=object_group_id,json=objectGroupId,proto3" json:"object_group_id,omitempty"`
...
func (x *ObjectGroupRevision) GetDatasetId() uint64 {
	if x != nil {
		return x.DatasetId
	}
	return 0
...
func (x *ObjectGroupRevision) GetObjectGroupId() uint64 {
	if x != nil {
...
var file_api_models_v1_object_models_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09,
	...
	0x65, 0x61, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x68, 0x65,
	...
	0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x64, 0x61, 0x74,
	...
	0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x6f, 0x62, 0x6a,
